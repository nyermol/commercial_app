...
Также вы можете установить приложение как PWA, перейдя по это ссылке: https://nyermol.github.io/commercial_app_web/ (но войти все равно не сможете, так как там установлена авторизация 🙃)
